  ...
  return (
    <div className="flex items-center justify-between w-full md:[65%]">
      ...
      <div className="relative w-[87%] md:hidden mr-3 ml-2">
        <input type="text" name="search" placeholder="جستجو در" className="w-full h-[43px] bg-[#f0f0f1] outline-none border-none pr-[50px] font-['IRANYekanWeb'] rounded-[7px] transition-all duration-300 placeholder:font-bold placeholder:text-[12px] focus:placeholder:text-gray-500" />
      ...
      <div className="relative hidden md:block w-auto">
        <input type="text" name="search" placeholder="جستجو" className="w-[600px] h-[43px] bg-[#f0f0f1] outline-none border-none pr-[50px] font-['IRANYekanWeb'] rounded-[7px] transition-all duration-300 placeholder:font-bold placeholder:text-[12px] focus:placeholder:text-gray-500" />
        <img src="/images/search.svg" alt="search" className="absolute right-2 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
      </div>
