    ...
    <div className="w-full bg-white border-t border-[#eee] md:hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-[#eee]">
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col items-start">
            <span className="text-[14px] font-yekan font-bold">تماس با پشتیبانی</span>
            <span className="text-[11px] font-yekan text-gray-500">۷ روز هفته، ۲۴ ساعته</span>
          </div>
        </div>
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-[#eee]">
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-col items-start">
            <span className="text-[14px] font-bold font-yekan">اپلیکیشن دیجی‌کالا</span>
            <span className="text-[11px] text-gray-500 font-yekan">تجربه خرید بهتر در اپ</span>
          </div>
        </div>
      ...
      <div className="divide-y divide-[#eee] mb-3">
        {footerMenus.map((menu, idx) => (
          <div key={idx} className="flex items-center justify-between px-4 py-3">
            <span className="text-[14px] font-yekan font-bold">{menu}</span>
      ...
      <div className="inline-block align-top w-[864.5px] h-[150.233px] mx-3">
        ...
        <h1 className="text-lg font-bold mb-4 font-yekan mt-3">دیجی کالا بزرگترین فروشگاه آنلاین ایران</h1>
        <p className=" w-full  text-[10px] text-[#767790] leading-[26.0333px] font-yekan text-right  line-clamp-3 [&>*:nth-child(3)]:text-[#9e9fb1]">
