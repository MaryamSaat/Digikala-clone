  ...
  return (
    <div className="w-full flex flex-col items-center mb-[23px]">
      ...
      <div className="w-[87%] md:h-[45px] flex items-center justify-center mb-[53px] mt-[10px]">
        <h2 className="text-[21px] font-bold font-['IRANYekanWeb'] text-center">خرید بر اساس دسته بندی</h2>
      </div>
          ...
          {categories.map((category) => (
            <SwiperSlide key={category.id}>
              <div className="flex flex-col items-center gap-1 md:gap-2">
                ...
                <p className="text-[11px] md:text-[12px] text-center font-['IRANYekanWeb']">{category.title}</p>
              </div>
            </SwiperSlide>
          ))}
        </Swiper>
